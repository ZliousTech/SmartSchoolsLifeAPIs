...
namespace SmartSchoolAPI.DataServiceFactory
{
    ...
    {
        private static ISmartSchool_To_IntegrationSchoolClassDSL _smartSchool_To_IntegrationSchoolClass { get; } =
        ...
        {
            return await _smartSchool_To_IntegrationSchoolClass.GetTeacherSchoolClasses(teacherId);
        }
    }
}